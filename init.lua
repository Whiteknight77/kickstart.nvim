...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>T', group = '[T]oolchains / Dev[t]ools' },
      },
    },
  },
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- ts_ls = {},
        --
        clangd = {}, -- Kickstart-Recommendation
        ...
        jdtls = { -- Java LS
          java = {
            ...
            completion = {},
            configuration = {
              -- This block defines the used jdks:
              runtimes = {
                {
                  name = 'Java-1.8',
                  -- TODO: on new systems: enter according path:
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Automatically pair brackets and quotation marks
      --
